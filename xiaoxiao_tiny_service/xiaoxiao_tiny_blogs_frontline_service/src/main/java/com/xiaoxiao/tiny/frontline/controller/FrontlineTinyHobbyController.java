...
{
    @Autowired
    private FrontlineTinyHobbyService frontlineTinyHobbyService;


    @ApiOperation(value = "查找我的爱好",response = Result.class,notes = "查找我的爱好")
    @PostMapping(value = "/find_me_hobby")
    public Result findMeHobby(){
        return this.frontlineTinyHobbyService.findMeHobby();
    }
}
