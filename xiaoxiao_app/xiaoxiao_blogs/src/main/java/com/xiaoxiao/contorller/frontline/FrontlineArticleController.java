...
public class FrontlineArticleController {
    ...
    public Result findBlogsBySorts(@RequestParam(name = "page", defaultValue = "1") Integer page,
        @RequestParam(name = "rows", defaultValue = "10") Integer rows, @RequestParam(name = "sortId") Long sortId) {
        return this.frontlineArticleService.findBlogsBySorts(page, rows, sortId);
    }
    ...
    public Result findArticleByLabelId(@RequestParam(name = "labelId") Long labelId,
        ...
        @RequestParam(name = "rows", defaultValue = "10") Integer rows) {
        return this.frontlineArticleService.findArticleByLabelId(labelId, page, rows);
    }
