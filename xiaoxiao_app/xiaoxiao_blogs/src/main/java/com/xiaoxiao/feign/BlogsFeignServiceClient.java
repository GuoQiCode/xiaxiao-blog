...
public interface BlogsFeignServiceClient {
     ...
     * @return
     */
    @PostMapping(value = "/admin/tiny_head_photo_service/findAll")
    Result findAllHeadPhoto(@RequestParam(name = "page", defaultValue = "1") Integer page,
        @RequestParam(name = "rows", defaultValue = "10") Integer rows);
     ...
     * @return
     */
    @PostMapping(value = "/admin/tiny_head_photo_service/findOne")
    Result findOne(@RequestBody XiaoxiaoHeadPhoto xiaoxiaoHeadPhoto);
     ...
     * @return
     */
    @PostMapping(value = "/admin/tiny_head_photo_service/delete")
    Result delete(@RequestBody XiaoxiaoHeadPhoto xiaoxiaoHeadPhoto);
     ...
     * @return
     */
    @PostMapping(value = "/admin/tiny_head_photo_service/insert")
    Result insert(@RequestBody XiaoxiaoHeadPhoto xiaoxiaoHeadPhoto);
