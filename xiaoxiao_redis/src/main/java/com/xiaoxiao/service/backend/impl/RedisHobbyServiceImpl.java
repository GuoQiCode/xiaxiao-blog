 ...
 */
@Service
public class RedisHobbyServiceImpl implements RedisHobbyService
{
    ...
    {
        this.redisTemplate.opsForValue().set(this.MY_HOBBY, list, 7, TimeUnit.DAYS);
    }
    ...
    {
        return (List<XiaoxiaoHobby>) this.redisTemplate.opsForValue().get(this.MY_HOBBY);
    }
}
