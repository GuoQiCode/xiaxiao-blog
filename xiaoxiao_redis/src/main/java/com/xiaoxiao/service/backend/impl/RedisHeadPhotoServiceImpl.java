...
public class RedisHeadPhotoServiceImpl implements RedisHeadPhotoService
{
    ...
    {
        this.redisTemplate.opsForValue().set(HEAD_PHOTO, xiaoxiaoHeadPhotos, 30, TimeUnit.DAYS);
    }
    ...
    public List<XiaoxiaoHeadPhoto> getHeadPhoto()
    {
        ...
        return (List<XiaoxiaoHeadPhoto>) this.redisTemplate.opsForValue().get(this.HEAD_PHOTO);
    }

    @Override
    public void deleteHeadPhoto()
    {
        this.redisTemplate.delete(this.HEAD_PHOTO);
    }
}
